...
<html lang="en">
	<head>
		...
		<title>Tour Tracker :: Administrative Panel</title>
		...
		<link rel="stylesheet" href="{{asset('adminassets/plugins/dropzone/min/dropzone.min.css')}}">
		<!-- Theme style -->
	...
	<body class="hold-transition sidebar-mini">
		...
		<div class="wrapper">
			...
			<footer class="main-footer">
				...
				<strong>Copyright &copy; 2020-2024 Tour Tracker rights reserved.
			</footer>
