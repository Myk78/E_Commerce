        ...
        $.ajax({
            ...
            success: function(response){
                ...
                if(response["status"]==true){
                    ...
                    $("#category").removeClass('is-valid').siblings('p').removeClass('invalid-feedback').html("");
                    ...
                    if(errors['category']){
                        $("#category").addClass('is-valid').siblings('p').addClass('invalid-feedback').html(errors['category']);
                    }
                    else{
                        $("#category").removeClass('is-valid').siblings('p').removeClass('invalid-feedback').html("");
