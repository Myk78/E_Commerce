        ...
        <div class="container-fluid">
            ...
            <form action="" method="get">
                            ...
                            @if ($subCategories->isNotEmpty())
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('categories.edit',$subCategories->id)}}">
                                        ...
                                        {{-- <form action=" {{ route("categories.delete", $subCategories->id ) }}" method="post">
                                            @method("DETELE")
                                            @csrf
                                            <button   class="text-danger w-4 h-4 mr-1">
                ...
                <div class="card-footer clearfix">
                    ...
                    {{-- ajax kay masla ki waja say error ah rah h 
                    Method Illuminate\Database\Eloquent\Collection::link does not exist. --}}
                    {{-- {{$subCategories->link()}} --}}
