                ...
                <div class="container">
                    <div class="light-font">
                        <ol class="breadcrumb primary-color mb-0">
                            <li class="breadcrumb-item"><a class="white-text" href="{{route('front.Hotel.HotelPage')}}">HotelHome</a></li>
                            <li class="breadcrumb-item">Hotel Sawat
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-7">
                            <div class="bg-light right">
                                <h1>Hotel Sawat</h1>
                                <div class="linespace">
                                    <label class="mx-2 mb-2 front fs-4"><b>Per Night:</b></label> <label class="fs-5">Rs 8000</label>
                                  </div>
                                  <div class="linespace">
                    ...
                    <div class="container">
                        <div class="row mx-auto">
                              ...
                              <div class="col-12 col-md-6 mb-3">
                                <label for="pnum" class="col-sm-2 col-form-label">Select Hotel</label>
                                <div class="col-sm-10">                                   <select name="status" id="Rtype" class="form-control">
                                        <option value="1">Sawat lagon</option>
                                        <option value="0">High five</option>
                                        <option value="0">NAran hotel</option>
                                    </select>
                                </div>
                            </div>
                              <div class="col-12 col-md-6 mb-3">
                            ...
                            <div class="col-12 col-md-6 mb-3">
                                <label for="pnum" class="col-sm-2 col-form-label">Per night</label>
                                <div class="col-sm-10">
                                     <select name="status" id="Rtype" class="form-control">
                                        <option value="2">set the price</option>
                              ...
                              <div class="col-12 col-md-6 mb-3">
                                <label for="exampleFormControlInput1" class="form-label label">CheckIn Date</label>
                                <div class="col-sm-10">
                                    <input type="datetime-local" class="form-control"  id="exampleFormControlInput1" placeholder="name@example.com">
                                </div>
                              </div>
                              <div class="col-12 col-md-6 mb-3">
                                <label for="exampleFormControlInput1" class="form-label label">CheckOut Date</label>
                                <div class="col-sm-10">
                                    <input type="datetime-local" class="form-control"  id="exampleFormControlInput1" placeholder="name@example.com">
                                </div>
                              </div>
