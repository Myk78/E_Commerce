        ...
        <div class="container">
            <div class="light-font">
                <ol class="breadcrumb primary-color mb-0">
                    ...
                    <li class="breadcrumb-item">Sindhi Topi</li>
                </ol>
            </div>
        </div>
    </section>
            ...
            <div class="row ">
                    ...
                    <div id="product-carousel" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner bg-light">
                            <div class="carousel-item">
                                <img class="w-100 h-100" src="{{asset('Ecomfront-assets/images/product-1.jpg')}}" alt="Image">
                            </div>
                            <div class="carousel-item active">
                                <img class="w-100 h-100" src="{{asset('Ecomfront-assets/images/product-2.jpg')}}" alt="Image">
                            </div>
                            <div class="carousel-item">
                                <img class="w-100 h-100" src="{{asset('Ecomfront-assets/images/product-3.jpg')}}" alt="Image">
                            </div>
                            <div class="carousel-item">
                ...
                <div class="col-md-7">
                    <div class="bg-light right">
                        ...
                        <a href="{{route('front.Cart.detail')}}" class="btn btn-dark"><i class="fas fa-shopping-cart"></i> &nbsp;ADD TO CART</a>
                    </div>
                </div>
                    ...
                    <div class="card product-card">
                        <div class="product-image position-relative">
                            ...
                            <div class="product-action">
                                <a class="btn btn-dark" href="{{route('front.Cart.detail')}}">
