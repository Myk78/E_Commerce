...
<head>
	...
	{{-- <link rel="stylesheet" type="text/css" href="{{asset('Ecomfront-assests/css/slick.css')}}" />
	<link rel="stylesheet" type="text/css" href="{{asset('Ecomfront-assests/css/slick-theme.css')}}" />
	<link rel="stylesheet" type="text/css" href="{{asset('Ecomfront-assests/css/style.css')}}"/>
    <link rel="stylesheet" type="text/css" href="{{asset('Ecomfront-assests/css/style.min.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('Ecomfront-assests/css/video-js.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('Ecomfront-assests/css/style.css?v=<?php echo rand(111,999); ?>')}}" /> --}}

    <link rel="stylesheet" type="text/css" href="{{asset('Ecomfront-assets/css/slick.css')}}" />
	<link rel="stylesheet" type="text/css" href="{{asset('Ecomfront-assets/css/slick-theme.css')}}" />
	<link rel="stylesheet" type="text/css" href="{{asset('Ecomfront-assets/css/style.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('Ecomfront-assets/css/style.min.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('Ecomfront-assets/css/video-js.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('Ecomfront-assets/css/style.css?v=<?php echo rand(111,999); ?>')}}" />
